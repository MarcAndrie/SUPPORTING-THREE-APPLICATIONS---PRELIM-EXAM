        ...
        <div class="col-md-7">
          ...
          <div class="card shadow mt-4 mb-4">
            <div class="card-body">
              ...
              <p class="mt-2"><strong>Category:</strong> <?php echo htmlspecialchars($proposal['category_name'] ?? 'N/A'); ?> | <strong>Subcategory:</strong> <?php echo htmlspecialchars($proposal['subcategory_name'] ?? 'N/A'); ?></p>
    ...
    <script>
      $(document).ready(function() {
        $('#category_id').change(function() {
          ...
          if (categoryId) {
            $.ajax({
              url: 'core/get_subcategories.php',
              type: 'POST',
