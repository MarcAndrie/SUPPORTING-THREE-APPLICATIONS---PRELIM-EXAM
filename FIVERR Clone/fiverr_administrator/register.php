...
<head>
  ...
  <title>Fiverr Administrator Register</title>
</head>
<body>
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-md-8 p-5">
        ...
        <div class="card-header">
          <h2>Welcome to Fiverr Administrator panel! Register Now!</h2>
        </div>
        <form action="core/handleForms.php" method="POST">
          <div class="card-body">
            ...
            <input type="hidden" name="is_fiverr_administrator" value="1">
